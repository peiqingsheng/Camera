...
public class CameraView extends FrameLayout {
    ...
    public void setPictureHeight(int height) {
        ...
        mImpl.setPictureHeight(mPictureHeight);
    }
    ...
    public int getCurrentOrientation() {
        return mDisplayOrientationDetector.getCurrentOrientation();
    }

    public void setViewsRotation(List<View> views) {
        mDisplayOrientationDetector.setViewsRotation(views);
    }
}
